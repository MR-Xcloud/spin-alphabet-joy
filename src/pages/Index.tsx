    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="text-center py-8 px-4">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
          Test your luck with our professional spin wheel! Click the button to spin and discover your lucky letter.
        </p>
      </header>
        ...
        {gameStats.totalSpins > 0 && (
          <Card className="mt-8 p-6 bg-card/50 backdrop-blur-sm border-border/50">
            <div className="text-center space-y-4">
              <h3 className="text-lg font-semibold text-foreground">Game Stats</h3>
              <div className="flex flex-col md:flex-row md:space-x-8 space-y-4 md:space-y-0">
                <div>
                  <p className="text-sm text-muted-foreground">Total Spins</p>
                  <p className="text-2xl font-bold text-game-primary">{gameStats.totalSpins}</p>
                </div>
                {gameStats.lastWinners.length > 0 && (
                  <div>
                    <p className="text-sm text-muted-foreground">Recent Letters</p>
